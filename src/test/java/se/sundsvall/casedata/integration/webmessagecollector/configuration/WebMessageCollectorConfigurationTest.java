...
class WebMessageCollectorConfigurationTest {
	...
	@Mock
	private WebMessageCollectorProperties propertiesMock;

	@Test
	void testFeignBuilderCustomizer() {
		final var configuration = new WebMessageCollectorConfiguration();
