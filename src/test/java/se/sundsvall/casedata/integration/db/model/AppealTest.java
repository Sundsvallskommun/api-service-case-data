...
class AppealTest {
	...
	void testNoDirtOnCreatedBean() {
		assertThat(Appeal.builder().build()).hasAllNullFieldsOrPropertiesExcept("status", "timelinessReview", "version");
		assertThat(new Appeal()).hasAllNullFieldsOrPropertiesExcept("status", "timelinessReview", "version");
	}
