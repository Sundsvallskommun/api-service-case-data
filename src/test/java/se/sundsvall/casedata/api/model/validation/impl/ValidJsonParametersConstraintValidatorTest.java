...
class ValidJsonParametersConstraintValidatorTest {
	...
	void validJsonParameters() {
		final var attributes = Map.of("municipalityId", MUNICIPALITY_ID);
		final var schemaId = "testSchema";
		final var jsonValue = createJsonNode();
		final var jsonParameter = JsonParameter.builder()
			.withKey("testKey")
	...
	void validatesMultipleParameters() {
		...
		final var jsonParameter1 = JsonParameter.builder()
			.withKey("key1")
			.withSchemaId(schemaId1)
			.withValue(jsonValue1)
			.build();

		final var jsonParameter2 = JsonParameter.builder()
			.withKey("key2")
	...
	void validatesAllParametersEvenWhenSomeFail() {
		...
		final var jsonParameter3 = JsonParameter.builder()
			.withKey("key3")
