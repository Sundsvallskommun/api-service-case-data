...
VALUES (1, '2022-12-02 15:13:45.363', '2022-12-02 15:15:01.563', 1, NULL,
       ...
       (3, '2022-12-02 15:13:45.363', '2022-12-02 15:15:01.563', 1, NULL,
         'Nytt parkeringstillstånd', 'PARKING_PERMIT', 'UNKNOWN', 'WSO2_test', '', '', NULL,
         'ERRAND-NUMBER-3', '', '2281', 'Aktualisering', 'MEDIUM',
         '896a44d8-724b-11ed-a840-0242ac110002', NULL, 'UNKNOWN', 'WSO_test', NULL, 'MY_NAMESPACE');
...
VALUES (1, '2022-12-02 15:13:45.363', '2022-12-02 15:15:01.563', 0, 'AD-1', NULL, 'FIRST-NAME-1',
       ...
       (2, '2022-12-02 15:13:45.363', '2022-12-02 15:15:01.563', 0, 'AD-1', NULL, 'FIRST-NAME-1',
        ...
        'MY_NAMESPACE'),
       (3, '2022-12-02 15:13:45.363', '2022-12-02 15:15:01.563', 0, 'AD-1', NULL, 'FIRST-NAME-1',
        'LAST-NAME-1', NULL, NULL, 'd7af5f83-166a-468b-ab86-da8ca30ea97c', 'PERSON', 3, '2281',
        'MY_NAMESPACE');

INSERT INTO stakeholder_roles(stakeholder_id, roles, role_order)
VALUES (3, 'APPLICANT', 0),
       (2, 'ADMINISTRATOR', 0);
...
VALUES (1, '2024-01-01 12:00:00.000', '2024-01-01 12:00:00.000', 2, 1, 1,
        ...
        (1, '2024-01-01 12:00:00.000', '2024-01-01 12:00:00.000', 3, 3, 2,
        '2024-01-01 12:00:00.000', '2024-01-01 12:00:00.000', '2025-01-01 12:00:00.000',
        'Some description', 'APPROVAL', 'FINAL', '2281', 'MY_NAMESPACE');
