INSERT INTO errand (id, created, updated, version, application_received, case_title_addition, case_type, created_by,
...
INSERT INTO decision(version, created, decided_at, decided_by_id, errand_id, id, updated,
                     valid_from, valid_to, description, decision_outcome, decision_type, municipality_id)
VALUES (1, '2024-01-01 12:00:00.000', '2024-01-01 12:00:00.000', 2, 1, 3,
        ...
        'Some description', 'APPROVAL', 'RECOMMENDED','2281');

INSERT INTO facility (id,created,updated,version,address_category,apartment_number,attention,care_of,city,country,house_number,invoice_marking,is_zoning_plan_area,latitude,longitude,postal_code,property_designation,street,description,facility_collection_name,main_facility,errand_id,facility_type,municipality_id)
VALUES (1,'2024-04-25 15:37:23.525120','2024-04-26 08:14:14.039373',2,'POSTAL_ADDRESS','apartmentNumber 1','Attention','Cateof 1','City 1','Country 1','HouseNumber 1','invoiceMarking 1',1,3.0,2.0,'PostalCode 1','PropertyDesignation 1','Street 1','Description 1','FacilityCollectionName 1',1,1,'WORKSHOP_BUILDING', '2281'),
        (4,'2024-04-25 15:37:23.525120','2024-04-26 08:14:14.039373',2,'POSTAL_ADDRESS','apartmentNumber 2','Attention','Cateof 2','City 2','Country 2','HouseNumber 2','invoiceMarking 2',1,3.0,2.0,'PostalCode 2','PropertyDesignation 2','Street 2','Description 2','FacilityCollectionName 3',1,1,'WORKSHOP_BUILDING', '2281');
...
INSERT INTO note (id, created, updated, version, created_by, `text`, title, updated_by, errand_id, municipality_id)
VALUES (5, '2023-10-02 15:13:45.363', '2023-10-02 15:13:45.363', 1, 'UNKNOWN', 'TEXT', 'TITLE-1', 'testUser', 1, '2281');
...
INSERT INTO jv_snapshot(snapshot_pk, type, version, state, changed_properties, managed_type, global_id_fk, commit_fk)
