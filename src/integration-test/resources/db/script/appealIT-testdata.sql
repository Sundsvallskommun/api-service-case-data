INSERT INTO errand (id, created, updated, version, application_received, case_title_addition,
                    ...
                    process_id, start_date, updated_by, updated_by_client, channel, case_type)
...
INSERT INTO decision (id, created, updated, version, decided_at, decision_outcome, decision_type,
                      ...
                      namespace)
VALUES (1, '2024-04-17 11:42:42.367478', '2024-04-17 11:42:42.367478', 0, '2024-04-17 11:38:47.49',
        'APPROVAL', 'RECOMMENDED', 'string', '2024-04-17 11:38:47.49', '2024-04-17 11:38:47.49', 1,
        1, '2281', 'my.namespace'),
       (2, '2024-04-17 12:42:42.367478', '2024-04-17 12:42:42.367478', 0, '2024-04-17 12:38:47.49',
        'DISMISSAL', 'RECOMMENDED', 'string', '2024-04-17 11:38:47.49', '2024-04-17 11:38:47.49', 1,
        1, '2281', 'my.namespace');;

INSERT INTO appeal (id, version, appeal_concern_communicated_at, created, decision_id, errand_id,
                    registered_at, updated, description, status, timeliness_review, municipality_id,
                    namespace)
VALUES (1, 0, '2024-04-17 11:44:11.089', '2024-04-17 11:45:54.256607', 1, 1,
        '2024-04-17 11:44:11.089', '2024-04-17 11:45:54.256607', 'Test överklagan', 'NEW',
        'NOT_CONDUCTED', '2281', 'my.namespace');
