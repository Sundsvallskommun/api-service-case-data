...
INSERT INTO stakeholder (id, created,updated,version,ad_account,authorized_signatory,first_name,last_name,organization_name,organization_number,person_id,`type`,errand_id) VALUES
	 (1, '2024-04-17 11:42:42.362476','2024-04-17 11:42:42.362476',0,'string','Test Testorsson','Test','Testorsson','Sundsvalls testfabrik','19901010-1234','3ed5bc30-6308-4fd5-a5a7-78d7f96f4438','PERSON', 1);
