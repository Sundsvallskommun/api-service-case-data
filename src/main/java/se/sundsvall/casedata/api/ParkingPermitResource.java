...
@RestController
@Validated
@RequestMapping("/parking-permits")
...
class ParkingPermitResource {
	...
	ResponseEntity<List<GetParkingPermitDTO>> getAllParkingPermits(@Parameter(description = "personId of the applicant") @RequestParam(required = false) final String personId) {
		return ResponseEntity.ok(parkingPermitService.findAll(personId));
	}
