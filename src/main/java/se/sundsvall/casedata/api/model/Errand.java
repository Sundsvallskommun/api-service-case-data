...
public class Errand {
	...
	@Schema(description = "The id of the errand", accessMode = READ_ONLY, example = "1")
	private Long id;

	@Schema(description = "The version of the errand", accessMode = READ_ONLY, example = "1")
	private int version;

	@Schema(description = "Errand number", example = "PRH-2022-000001", accessMode = READ_ONLY)
	...
	@Schema(description = "Diary number", example = "DIA123456", maxLength = 255)
	@Size(max = 255)
	private String diaryNumber;

	@Schema(description = "Phase of the errand", example = "Aktualisering", maxLength = 255)
	@Size(max = 255)
	private String phase;

	@Schema(description = "The current status of the errand", maxLength = 255)
	...
	@Schema(description = "Process-ID from ProcessEngine", example = "c3cb9123-4ed2-11ed-ac7c-0242ac110003", accessMode = READ_ONLY)
	...
	@Schema(description = "Date and time when the errand was created", accessMode = READ_ONLY, example = "2023-10-01T12:00:00Z")
	@TimeZoneStorage(NORMALIZE)
	private OffsetDateTime created;

	@Schema(description = "Date and time when the errand was last updated", accessMode = READ_ONLY, example = "2023-10-02T12:00:00Z")
	@TimeZoneStorage(NORMALIZE)
