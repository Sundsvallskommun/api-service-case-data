...
public class Stakeholder {
	...
	@Schema(accessMode = READ_ONLY, description = "The unique identifier of the stakeholder", example = "1")
	private Long id;

	@Schema(accessMode = READ_ONLY, description = "The version of the stakeholder", example = "1")
	private int version;
	...
	@Size(max = 255)
	@Schema(description = "The first name of the stakeholder", example = "Test", maxLength = 255)
	private String firstName;

	@Size(max = 255)
	@Schema(description = "The last name of the stakeholder", example = "Testorsson", maxLength = 255)
	...
	@Size(max = 255)
	@Schema(description = "The organization name of the stakeholder", example = "Sundsvalls testfabrik", maxLength = 255)
	private String organizationName;

	@Size(max = 13)
	@Pattern(regexp = Constants.ORGNR_PATTERN_REGEX, message = Constants.ORGNR_PATTERN_MESSAGE)
	@Schema(description = "Organization number with 10 or 12 digits.", example = "19901010-1234", maxLength = 13)
	private String organizationNumber;

	@Size(max = 255)
	@Schema(description = "The authorized signatory of the stakeholder", example = "Test Testorsson", maxLength = 255)
	private String authorizedSignatory;

	@Schema(description = "The AD-account of the stakeholder", example = "user", maxLength = 36)
	@Size(max = 36)
	...
	@Schema(accessMode = READ_ONLY, description = "The timestamp when the stakeholder was created", example = "2023-01-01T12:00:00Z")
	@TimeZoneStorage(NORMALIZE)
	private OffsetDateTime created;

	@Schema(accessMode = READ_ONLY, description = "The timestamp when the stakeholder was last updated", example = "2023-01-02T12:00:00Z")
	@TimeZoneStorage(NORMALIZE)
