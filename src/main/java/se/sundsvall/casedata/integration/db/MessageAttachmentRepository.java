...
public interface MessageAttachmentRepository extends JpaRepository<MessageAttachment, String> {
	...
	Optional<MessageAttachment> findByAttachmentIDAndMunicipalityIdAndNamespace(final String attachmentId, final String municipalityId, final String namespace);
