...
public class JsonSchemaConfiguration {
	...
	@Bean
	FeignBuilderCustomizer feignBuilderCustomizer(final JsonSchemaProperties jsonSchemaProperties, final ClientRegistrationRepository clientRegistrationRepository) {
