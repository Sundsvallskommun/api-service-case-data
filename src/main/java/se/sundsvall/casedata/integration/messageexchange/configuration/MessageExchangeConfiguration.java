...
import se.sundsvall.casedata.integration.employee.configuration.EmployeeProperties;
...
public class MessageExchangeConfiguration {
	...
	@Bean
	FeignBuilderCustomizer feignBuilderCustomizer(final ClientRegistrationRepository clientRepository, final EmployeeProperties messageExchangeProperties) {
